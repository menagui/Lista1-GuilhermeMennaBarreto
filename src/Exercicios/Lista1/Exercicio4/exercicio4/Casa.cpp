...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercicio 4 - Casa", nullptr, nullptr);
	if (!window)
	{
	...
	// Gerando um buffer simples com todas as partes da casa
	...
	while (!glfwWindowShouldClose(window))
	{
		// Este trecho de código é totalmente opcional: calcula e mostra a contagem do FPS na barra de título
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0)
			{
				...
				char tmp[256];
				sprintf(tmp, "Exercicio 4 - Casa\tFPS %.2lf", fps);
...
// Esta função cria os buffers que armazenam as partes da casa
// Apenas atributo coordenada nos vértices
// 1 VBO com as coordenadas, VAO com apenas 1 ponteiro para atributo
// A função retorna o identificador do VAO
int setupGeometry()
{
	// Todas as formas ficam no mesmo VBO. Cada parte ocupa uma faixa de vertices,
	// que depois e desenhada separadamente no loop principal.
	GLfloat vertices[] = {
		// Corpo da casa: vertices 0 a 5
		-0.45f,  0.25f, 0.0f,
		-0.45f, -0.55f, 0.0f,
		 0.45f, -0.55f, 0.0f,
		-0.45f,  0.25f, 0.0f,
		...
		// Telhado: vertices 6 a 8
		-0.55f, 0.25f, 0.0f,
		 0.00f, 0.75f, 0.0f,
		 0.55f, 0.25f, 0.0f,

		// Porta: vertices 9 a 14
		 0.10f, -0.10f, 0.0f,
		 0.10f, -0.55f, 0.0f,
		 0.30f, -0.55f, 0.0f,
		 0.10f, -0.10f, 0.0f,
		...
		// Divisoes da janela: vertices 21 a 24
		-0.20f,  0.15f, 0.0f,
		-0.20f, -0.05f, 0.0f,
		-0.30f,  0.05f, 0.0f,
		-0.10f,  0.05f, 0.0f,

		// Linha do chao: vertices 25 e 26
		-0.70f, -0.55f, 0.0f,
		 0.70f, -0.55f, 0.0f,
